...
gameData.requirements = {
    ...
    // Pirates Guild
    "Normal Sailor": new TaskRequirement([getTaskElement("Normal Sailor")], [{task: "Elite knight", requirement: 100}, {task: "Fisherman", requirement: 500},{task: "Strength", requirement: 500}, {task: "Sailing Mastery", requirement: 500}]),
    "Sailor Captain": new TaskRequirement([getTaskElement("Sailor Captain")], [{task: "Holy knight", requirement: 100}, {task: "Normal Sailor", requirement: 25}, {task: "Strength", requirement: 750}, {task: "Sailing Mastery", requirement: 1000}]),
